...
import 'package:trust_pay_polaris/components/buttons/transaction_card_accept_btn.dart';
import 'package:trust_pay_polaris/components/buttons/transaction_card_reject_btn.dart';
import 'package:trust_pay_polaris/components/buttons/transaction_card_single_btn.dart';
...
class TransactionAlertCard extends StatelessWidget {
  ...
  const TransactionAlertCard({super.key, required this.type, required this.userImage, required this.amount, required this.status, required this.width, required this.height, required this.username, required this.date});
...
_buildButtons(TransactionStatus status) {
  switch (status) {
    ...
    return const TransactionCardSingleButton(title: AppString.viewTransaction);
    default:
  }
}
