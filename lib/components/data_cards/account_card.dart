...
import 'package:trust_pay_polaris/components/buttons/transaction_card_withdraw_btn.dart';
import 'package:trust_pay_polaris/components/buttons/transaction_card_add_btn.dart';
...
class AccountCard extends StatefulWidget {
  ...
  final double height;
  final bool solid;
   AccountCard({super.key, required this.balance, required this.width, required this.height, required this.solid});
