...
class RejectTransactionPopup extends StatefulWidget {
  ...
  const RejectTransactionPopup({super.key, required this.width, required this.transactionTitle, required this.onCancel, required this.onComplete, required this.type, required this.sender, required this.receiver, required this.feedBackController});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          completed? TransactionConfirmationIllustration(
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  completed? 'Term of Transaction Rejected': 'Reject Transaction',
              ...
              Container(
                ...
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
                        text: completed? 'Rejected transaction ': 'Reject transaction ',
                        style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                !completed? InkWell(
                  ...
                  child: const SecondaryButton(title: "Cancel")
                ): Container(),
              ],
            ),
          ),
