...
class AcceptTransactionPopup extends StatefulWidget {
  ...
  const AcceptTransactionPopup({super.key, required this.width, required this.transactionTitle, required this.onCancel, required this.onComplete, required this.type, required this.sender, required this.receiver});
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  completed? 'Term of Transaction Accepted': 'Accept Transaction',
              ...
              Container(
                ...
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
                        text: completed? 'Accepted transaction ': 'Accept transaction ',
                        style: TextStyle(
