...
class ObligationCard extends StatefulWidget {
  ...
  final String amount;
  const ObligationCard({super.key, required this.width, required this.title, required this.description, required this.amount});
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  !expanded?Container(): SingleChildScrollView(
                    child: SizedBox(
                      width: double.infinity,
                      // height: height*2/6,
                      child: Text(
