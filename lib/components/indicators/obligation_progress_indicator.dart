...
class ObligationProgressIndicator extends StatelessWidget {
  ...
  final double width;
  const ObligationProgressIndicator({super.key, required this.fontSize, required this.width, required this.paymentsFulfilled, required this.obligationsTotal, required this.obligationsFulfilled});
...
_buildBars(
  int obligationTotal, 
  int obligationFulfilled,
  int paymentTotal, int paymentFulfilled ){
  List<Widget> list= [];
