...
class InvalidTransactionPopup extends StatefulWidget {
  ...
  const InvalidTransactionPopup({super.key, required this.width, required this.message, required this.onClick});

  @override
  State<InvalidTransactionPopup> createState() => _AcceptTransactionPopupState();
}
