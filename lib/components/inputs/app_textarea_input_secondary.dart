...
import 'package:trust_pay_polaris/components/base/card_number_formatter.dart';
...
class AppSecondaryTextAreaInput extends StatefulWidget {
  ...
  @override
  State<AppSecondaryTextAreaInput> createState() => _AppSecondaryTextAreaInputState();
}
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          ...
                          child: !widget.isDateInput? TextField(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  dateValue==null?
                                    'MM/YYYY':
                                    DateFormat('MM/yyyy').format(dateValue!),
                                  style: appTextGray16,
                                ),
                              ),
                            ],
